...
lsp_installer.on_server_ready(function(server)
  ...
  if server.name == "angularls" then
    ...
    local cmd = { "ngserver", "--stdio", "--tsProbeLocations", project_library_path, "--ngProbeLocations",
      project_library_path, "node",
      "/Users/liuweilun/.nvm/versions/node/v16.14.0/lib/node_modules/@angular/language-server",
      "/Users/liuweilun/.nvm/versions/node/v16.14.0/lib/node_modules/typescript" }
    opts = {
      on_attach = require("user.lsp.handlers").on_attach,
      capabilities = require("user.lsp.handlers").capabilities,
      cmd = cmd,
